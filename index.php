            ...
            $("#btn-cargar-codigo").on('click', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        let item = data[0];
                        let mac = item[2] != null ? item[2].trim() : '';
                        let departamento = item[1] != null ? item[1].trim() : '';
                        let usuario = item[0] != null ? item[0].trim() : '';
            ...
            if ($("#mac").val() && porCodigo === false) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#codigoCargar").val(item[0].trim());
                        $("#departamento").val(item[2].trim());
                        let departamento = $("#departamento").val();
                        let usuario = item[1].trim();
